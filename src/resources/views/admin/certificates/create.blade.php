...
@section('content')
    ...
    <form id="certificates-create" method="POST" action="{{ route('admin.certificates.store') }}" enctype="multipart/form-data">
        @csrf
      <div class="row">
        <div class="col-lg-8">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="tab-content mt-4">
                        ...
                        <div class="tab-pane" id="cover">
                            <div class="row">
                                <div class="col-lg-12">
                                    <input id="cover" type="file" name="image" class="form-control" multiple data-preview-file-type="text">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="pdf">
                            <div class="row">
                                <div class="col-lg-12">
                                    <input id="pdf" type="file" name="pdf" class="form-control" multiple data-preview-file-type="text">
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        $('input[type=file]').fileinput({
            ...
            allowedFileExtensions: ['jpg','jpeg','png', 'gif', 'svg', 'pdf'],
