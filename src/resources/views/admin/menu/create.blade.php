...
@section('content')
    ...
    <form id="menu-create" method="POST" action="{{ route('admin.menu.store') }}">
        @csrf
      <div class="row">
        <div class="col-lg-8">
            <div class="panel">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group form-material url required">
                        ...
                        <input type="text" class="form-control" required name="url" placeholder="Example: /services or https://google.com">
                        @if ($errors->has('url'))
