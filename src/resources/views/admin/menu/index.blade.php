...
@section('header_actions')
    <a class="btn btn-success btn-round" href="{{ route('admin.menu.create') }}">Create menu</a>
@endsection
                                    ...
                                    @foreach ($menu as $item)
                                        <li class="dd-item dd3-item" data-id="{{ $item['id'] }}">
                                            ...
                                            <div class="dd3-content">
                                                ...
                                                <a href="{{ route('admin.menu.edit', $item['id']) }}" class="btn btn-info btn-round btn-xs float-right">
                                                    <i class="md-edit"></i>
                                                </a>
                                            </div>
                                        </li>
...
@push('scripts')
    ...
    <script>
        let updateOutput = function (e) {
            ...
            let url = '{{ route('admin.menu.update-nestable') }}';
        ...
        $('button.delete-record').on('click', function (e) {
            ...
            targetForm.attr('action', '/admin/menu/' + record);
