...
@section('content')
    ...
    <form id="menu-create" method="POST" action="{{ route('admin.menu-item.store') }}" enctype="multipart/form-data">
        @csrf
      <div class="row">
        <div class="col-lg-8">
            <div class="panel">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group form-material description required">
                                        ...
                                        <input type="text" id="description-{{ $locale }}" class="form-control" name="description[{{ $locale }}]" aria-required="true" value="{{ old('description.' . $locale) }}">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group form-material url required">
                        ...
                        <input type="text" class="form-control" name="url" placeholder="Example: /services or https://google.com">
                        @if ($errors->has('url'))
