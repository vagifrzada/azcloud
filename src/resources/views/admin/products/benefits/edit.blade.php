...
@section('content')
    ...
    <form id="benefit-update" method="POST" action="{{ route('admin.product-benefits.update', ['product_benefit' => $benefit->id]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
      <div class="row">
        <div class="col-lg-8">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="tab-content mt-4">
                        @foreach ($supportedLocales as $locale => $info)
                            <?php $translation = $benefit->translate($locale) ?>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group form-material status required">
                        ...
                        <input id="status" type="checkbox" @if ($benefit->status == 1) checked @endif data-plugin="switchery" name="status" value="{{ old('status', 1)  }}">
