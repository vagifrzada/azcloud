                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group form-material title required">
                                        ...
                                        <input type="text" id="title-{{ $locale }}" maxlength="255"  class="form-control" name="title[{{ $locale }}]" aria-required="true" value="{{ $useCase->translate($locale)->title ?? '' }}">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group form-material status required">
                        ...
                        <input id="status" type="checkbox" @if ($useCase->status == 1) checked @endif data-plugin="switchery" name="status" value="{{ old('status', 1)  }}">
