    ...
    <div class="user-create">
        <div class="box">
            <div class="box-header with-border">
                <h3>Editing user: {{ $user->getName() }} </h3>
                <br>
            </div>

            <div class="box-body">
                <form id="users-create" action="{{ route('admin.users.update', ['user' => $user->getId()])  }}" method="post">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-lg-4">
                                ...
                                <div class="box-body">
                                    <div class="form-group form-material status required">
                                        ...
                                        <div class="form-group">
                                            <input id="status" type="checkbox" @if ($user->isActive()) checked @endif data-plugin="switchery" name="status" value="1">
                                        </div>
